	...
	panosList.then(function (panos) {
		...
		new TWEEN.Tween(pano.material)
			...
			.onComplete(function () {
				...
				url += api_key;
				//url = "<iframe id="airpano_frame" width="700" height="450" src="www.airpano.ru/files/Sahalin-Russia/2-3-2" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" framespacing="0"> </iframe> <br><div style="float:right">Courtesy of <a href="www.airpano.com/" target="_blank"></a></div>";
